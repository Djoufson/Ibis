...
def generate_advertisement(weather_id:int, max_tokens:int) -> tuple[dict[str, str], int]:
    ...
    prompt = f"Introducing our product named '{chosen_product.name}' for {weather_type.type_name} weather!"
